...
@onready var primary_cooldown_bar: Control = %HUD.get_node("VBoxContainer/HBoxContainer/PrimaryCooldownBar")
@onready var secondary_cooldown_bar: Control = %HUD.get_node("VBoxContainer/HBoxContainer/SecondaryCooldownBar")
